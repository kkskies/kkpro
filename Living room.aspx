<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Living room.aspx.cs" Inherits="Lazybug.Living_room" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Interior designing" Name="Work_category" 
                    QueryStringField="Interior designing" Type="String" />
                <asp:QueryStringParameter DefaultValue="Living room" 
                    Name="Work_type" QueryStringField="Living room" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
