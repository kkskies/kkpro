<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AC repair and services.aspx.cs" Inherits="Lazybug.AC_repair_and_services" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Electronic services" Name="Work_category" 
                    QueryStringField="Electronic services" Type="String" />
                <asp:QueryStringParameter DefaultValue="AC repair & services" 
                    Name="Work_type" QueryStringField="AC repair & services" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
