<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flowers delivery.aspx.cs" Inherits="Lazybug.Flowers_delivery" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Events Management" Name="Work_category" 
                    QueryStringField="Events Management" Type="String" />
                <asp:QueryStringParameter DefaultValue="Flowers delivery" 
                    Name="Work_type" QueryStringField="Flowers delivery" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
