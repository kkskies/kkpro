<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bathroom cleaning.aspx.cs" Inherits="Lazybug.Bathroom_cleaning" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Bathroom cleaning" 
                    Name="Work_type" QueryStringField="Bathroom cleaning" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
