<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="House cleaning.aspx.cs" Inherits="Lazybug.House_cleaning" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="House cleaning" 
                    Name="Work_type" QueryStringField="House cleaning" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
