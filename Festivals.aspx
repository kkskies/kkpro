<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Festivals.aspx.cs" Inherits="Lazybug.Festivals" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Festivals" 
                    Name="Work_type" QueryStringField="Festivals" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
