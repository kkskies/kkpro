<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Furniture.aspx.cs" Inherits="Lazybug.Furniture" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Furniture" 
                    Name="Work_type" QueryStringField="Furniture" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
