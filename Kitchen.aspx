<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kitchen.aspx.cs" Inherits="Lazybug.Kitchen" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Kitchen" 
                    Name="Work_type" QueryStringField="Kitchen" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
