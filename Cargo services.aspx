<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cargo services.aspx.cs" Inherits="Lazybug.Cargo_services" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Cargo services" 
                    Name="Work_type" QueryStringField="Cargo services" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
