<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laundry.aspx.cs" Inherits="Lazybug.Laundry" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Laundry" 
                    Name="Work_type" QueryStringField="Laundry" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
