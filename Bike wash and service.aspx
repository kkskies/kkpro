<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike wash and service.aspx.cs" Inherits="Lazybug.Bike_wash_and_service" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Automobile services" Name="Work_category" 
                    QueryStringField="Automobile services" Type="String" />
                <asp:QueryStringParameter DefaultValue="Bike wash and service" 
                    Name="Work_type" QueryStringField="Bike wash and service" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
