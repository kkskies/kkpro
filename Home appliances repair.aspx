<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home appliances repair.aspx.cs" Inherits="Lazybug.Home_appliances_repair" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Home appliances repair" 
                    Name="Work_type" QueryStringField="Home appliances repair" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
