<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cakes delivery.aspx.cs" Inherits="Lazybug.Cakes_delivery" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Cakes delivery" 
                    Name="Work_type" QueryStringField="Cakes delivery" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
