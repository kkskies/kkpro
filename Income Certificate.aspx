<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Income Certificate.aspx.cs" Inherits="Lazybug.Income_Certificate" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Income Certificate" 
                    Name="Work_type" QueryStringField="Income Certificate" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
