<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dot net.aspx.cs" Inherits="Lazybug.Dot_net" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue=".net" 
                    Name="Work_type" QueryStringField=".net" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
