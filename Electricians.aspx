<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Electricians.aspx.cs" Inherits="Lazybug.Electricians" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Civil services" Name="Work_category" 
                    QueryStringField="Civil services" Type="String" />
                <asp:QueryStringParameter DefaultValue="Electricians" 
                    Name="Work_type" QueryStringField="Electricians" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
