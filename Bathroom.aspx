<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bathroom.aspx.cs" Inherits="Lazybug.Bathroom" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Bathroom" 
                    Name="Work_type" QueryStringField="Bathroom" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
