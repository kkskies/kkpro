<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lock or Key repair.aspx.cs" Inherits="Lazybug.Lock_or_Key_repair" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Lock/Key repair" 
                    Name="Work_type" QueryStringField="Lock/Key repair" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
