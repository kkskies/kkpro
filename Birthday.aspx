<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Birthday.aspx.cs" Inherits="Lazybug.Birthday" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Birthday" 
                    Name="Work_type" QueryStringField="Birthday" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
