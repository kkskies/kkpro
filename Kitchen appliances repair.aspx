<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kitchen appliances repair.aspx.cs" Inherits="Lazybug.Kitchen_appliances_repair" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Home maintenance" Name="Work_category" 
                    QueryStringField="Home maintenance" Type="String" />
                <asp:QueryStringParameter DefaultValue="Kitchen appliances repair" 
                    Name="Work_type" QueryStringField="Kitchen appliances repair" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
