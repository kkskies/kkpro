<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Carpenters.aspx.cs" Inherits="Lazybug.Carpenters" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Carpenters" 
                    Name="Work_type" QueryStringField="Carpenters" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
