<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Computer services.aspx.cs" Inherits="Lazybug.Computer_services" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Computer services" 
                    Name="Work_type" QueryStringField="Computer services" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
