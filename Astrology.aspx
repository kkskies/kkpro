<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Astrology.aspx.cs" Inherits="Lazybug.Astrology" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Astrology" Name="Work_category" 
                    QueryStringField="Astrology" Type="String" />
                <asp:QueryStringParameter DefaultValue="Astrology" 
                    Name="Work_type" QueryStringField="Astrology" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
