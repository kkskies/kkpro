<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anniversary.aspx.cs" Inherits="Lazybug.Anniversary" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Anniversary" 
                    Name="Work_type" QueryStringField="Anniversary" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
