<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Driving School.aspx.cs" Inherits="Lazybug.Driving_School" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Driving School" 
                    Name="Work_type" QueryStringField="Driving School" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
