<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logo design.aspx.cs" Inherits="Lazybug.Logo_design1" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Logo design" 
                    Name="Work_type" QueryStringField="Logo design" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
