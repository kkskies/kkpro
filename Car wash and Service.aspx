<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Car wash and Service.aspx.cs" Inherits="Lazybug.Car_wash_and_Service" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Car wash and Service" 
                    Name="Work_type" QueryStringField="Car wash and Service" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
