<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Birth or Death Certificates.aspx.cs" Inherits="Lazybug.Birth_or_Death_Certificates" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="Document sevices" Name="Work_category" 
                    QueryStringField="Document sevices" Type="String" />
                <asp:QueryStringParameter DefaultValue="Birth or Death Certificates" 
                    Name="Work_type" QueryStringField="Birth or Death Certificates" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
