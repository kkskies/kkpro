<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Caste Certificate.aspx.cs" Inherits="Lazybug.Caste_Certificate" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Caste Certificate" 
                    Name="Work_type" QueryStringField="Caste Certificate" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
