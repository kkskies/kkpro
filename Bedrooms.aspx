<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bedrooms.aspx.cs" Inherits="Lazybug.Bedrooms" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="Bedrooms" 
                    Name="Work_type" QueryStringField="Bedrooms" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <br />
